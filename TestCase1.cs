...
namespace SeleniumProject1
{
    public class TestCase1
    {
        ...
        public void Test1()
        {
            ...
            driver.FindElement(By.XPath("//*[@id='new_form_job_search-keyword']")).SendKeys("Java");
          ...
          bool containsJava = vacancyContent.Text.Contains("Java");
          Assert.Pass("The vacancy content contains 'Java'.");
